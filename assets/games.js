...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style1', { style: 'zoom-in', speed: 1000, intensity: 2, delay: 375, staggerOrder: '', replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1500, staggerOrder: '', replay: false });
		onvisible.add('#container03 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#container04', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#container53 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('.icons.style2', { style: 'fade-up', speed: 1000, intensity: 5, delay: 250, stagger: 250, replay: false });
